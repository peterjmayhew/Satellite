...
class SatGPS_DB {
	...
	public static function create_table() {
		...
		$sql = "CREATE TABLE $table (
			...
			sbas_sys tinyint(2) NOT NULL DEFAULT -1,
			sbas_prn smallint(5) NOT NULL DEFAULT 0,
			sbas_cnt tinyint(3) NOT NULL DEFAULT 0,
			rx_module varchar(24) NOT NULL DEFAULT '',
			rx_fw varchar(32) NOT NULL DEFAULT '',
			rx_proto varchar(12) NOT NULL DEFAULT '',
			rx_gnss varchar(48) NOT NULL DEFAULT '',
			uart_tx_pct tinyint(4) NOT NULL DEFAULT -1,
			uart_tx_peak tinyint(4) NOT NULL DEFAULT -1,
			uart_rx_pct tinyint(4) NOT NULL DEFAULT -1,
			uart_ovf smallint(5) unsigned NOT NULL DEFAULT 0,
			geo_state tinyint(2) NOT NULL DEFAULT -1,
			geo_status tinyint(1) NOT NULL DEFAULT 0,
	...
	public static function insert_fix( array $d ) {
		...
		$ok = $wpdb->insert(
			...
			array(
				...
				'sbas_prn'     => $d['sbas_prn'],
				'sbas_cnt'     => $d['sbas_cnt'],
				'rx_module'    => $d['rx_module'],
				'rx_fw'        => $d['rx_fw'],
				'rx_proto'     => $d['rx_proto'],
				'rx_gnss'      => $d['rx_gnss'],
				'uart_tx_pct'  => $d['uart_tx_pct'],
				'uart_tx_peak' => $d['uart_tx_peak'],
				'uart_rx_pct'  => $d['uart_rx_pct'],
				'uart_ovf'     => $d['uart_ovf'],
				'geo_state'    => $d['geo_state'],
