...
<div id="satgps-app" class="satgps-app">
	...
	<section class="satgps-card">
		...
		<div class="satgps-tiles satgps-tiles-compact">
			...
			<div class="satgps-tile"><div class="satgps-tile-label"><?php esc_html_e( 'UART link load', 'satgps' ); ?><button type="button" class="satgps-help satgps-help-sm" data-help="uart" aria-label="<?php esc_attr_e( 'What is this?', 'satgps' ); ?>">?</button></div><div class="satgps-tile-value is-muted" data-field="uart">—</div><div class="satgps-bar satgps-bar-sm" aria-hidden="true"><span data-field="uart_bar" style="width:0%"></span></div><div class="satgps-tile-sub" data-field="uart_sub"><?php esc_html_e( 'receiver → host buffer', 'satgps' ); ?></div></div>
		</div>
	</section>
